export default function Contact({phone,email,address}) {
    return (
        <div className="leftcvsection contact">
            <h2>Contact</h2>
            <div>
                ...
                <address>{address || `Rohini, Delhi, India`}</address>
            </div>
            <div>
                ...
                <div className="phone">+91 {phone || `7817900580`}</div>
            </div>
            <div>
                ...
                <div className="mail">{email || `akshwalia20@gmail.com`}</div>
            </div>
        </div>
    )
}